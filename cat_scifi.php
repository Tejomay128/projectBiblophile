		...
		<div class="row">
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						<li><a href="indexphp.php">Home</a></li>
						<li class="active"><a href="cat_scifi.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Science Fiction</a></li>
					</ul>
				</div>
				...
				<div class="sidebar">
					<div class="sidebar_section">
						...
						<ul class="sidebar_categories">
                            <li class="active"><a href="cat_scifi.php"><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>Science Fiction</a></li>
                            
                            
                            <li><a href="cat_autobiography.php">Autobiography</a></li>
							...
							<li><a href="cat_histfict.php">Historical Fiction</a>
                            </li>
...
$sql = "SELECT * FROM books WHERE book_genre='Science Fiction'";

		...
		<div class="row">
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						<li><a href="indexphp.php">Home</a></li>
						<li class="active"><a href="cat_science.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Science</a></li>
					</ul>
				</div>
				...
				<div class="sidebar">
					<div class="sidebar_section">
						...
						<ul class="sidebar_categories">
                            <li class="active"><a href="cat_science.php"><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>Science</a></li>
...
$sql = "SELECT * FROM books WHERE book_genre='science'";
